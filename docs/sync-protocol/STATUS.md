...
| Sxema versiyasi | **v10** qo'llangan va tasdiqlangan (2026-08-27). **v11** (`activity_history.source`, A16 §1) kodda tayyor — 🔴 **BUILD HALI QILINMAGAN** (2026-08-28 holati), demak jonli bazada hamon v10 |
...
3. **Sxema v12** — `sync_outbox` + `sync_state`
   ⚠️ v9 band (placeholder tozalash), v10 band (`account_id`), v11 band (`activity_history.source` ustuni, A16 §1)
