...
| A9 | Upstream (rasmiy) versiya tekshiruvchisi — Custom Window'da rasmiy tdesktop'da yangi reliz bor-yo'qligini avto/qo'lda bildirish | 🔨 2026-08-08: spec tayyor va tasdiqlangan (`docs/superpowers/specs/2026-08-08-upstream-update-checker-design.md`), implementatsiya rejasi yozilmoqda |
