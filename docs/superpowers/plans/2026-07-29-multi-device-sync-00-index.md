...
| 1b | Backend sync yadrosi | `seq`, push/pull, media, kalitlar, pagination, WS, `.cmx` | `…-01b-backend-sync.md` |
| 2 | `tdesktop` sync agenti | Desktop ma'lumoti serverga chiqadi — birinchi haqiqiy qiymat | `…-02-tdesktop-agent.md` |
| 3 | `server-controller` web app | Ko'rish, boshqarish, statistika | `…-03-web-controller.md` |
| 4 | Storage lifecycle manager | Monitoring, retention, arxivlash, xavfsiz o'chirish | `…-04-storage-lifecycle.md` |
